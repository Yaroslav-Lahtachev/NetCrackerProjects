...
public class PurchaseDAOImpl extends BasicDAO implements IPurchaseDAO {
    ...
    public List<Purchase> task2c() {
        System.out.println("PurchaseDAOImpl.task2c");
    ...
    public List<Purchase> task4a() {
        System.out.println("PurchaseDAOImpl.task4a");
        SQLQuery query = getSession().createSQLQuery("SELECT buyers.name as BuyerName, shop.name as ShopName FROM purchase\n" +
    ...
    public List<Purchase> task4b() {
        System.out.println("PurchaseDAOImpl.task4b");
        SQLQuery query = getSession().createSQLQuery("SELECT purchase.date as Date, buyers.name as BuyerName, buyers.sale as BuyerSale, books.name as BookName, purchase.qty as CountBooks FROM purchase \n" +
                "left join buyers on (buyers.id_buyer=purchase.buyer)\n" +
    ...
    public List<Purchase> task5a(double total) {
        System.out.println("PurchaseDAOImpl.task5a");
    ...
    public List<Purchase> task5b(int month) {
        System.out.println("PurchaseDAOImpl.task5b");
    ...
    @Override
    public List<Purchase> task5c(String region) {
        System.out.println("PurchaseDAOImpl.task5c");
        Criteria criteria = getSession().createCriteria(Purchase.class);
        criteria.createAlias("buyer", "b")
                .createAlias("shop", "s")
                .add(Restrictions.between("b.sale", 10.0, 15.0))
    ...
    public List<Purchase> task5d() {
        System.out.println("PurchaseDAOImpl.task5d");
        Criteria criteria = getSession().createCriteria(Purchase.class);
